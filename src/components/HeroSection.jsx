...
import hero from "../assets/icons/hero-back.svg";
...
function HeroSection() {
  return (
    <section
      className="w-full h-[1103px] bg-contain bg-no-repeat bg-center "
      style={{ backgroundImage: `url(${hero})` }}
    >
      <Header />
      <div className="flex relative items-center text-center justify-center">
        <h1
          className="text-[252.594px] leading-[196px] tracking-[-16px] mt-[528px] font-geist"
          style={{
            background:
        ...
        <img className="absolute bottom-[45px]" src={AG} />
      </div>
     <div className="flex flex-col items-center justify-center mt-2 mb-16 ">
    <p className="text-white text-center font-mozilla font-[274] text-lg max-w-[950px] leading-[22px] tracking-[1px]">
      I am a passionate frontend developer, skilled in crafting visually appealing, responsive, and user-friendly web interfaces. With expertise in react, tailwind CSS & modern CSS, I bring ideas to life with precision and creativity.
    </p>
    <a href={resume} target="_blank" rel="noopener noreferrer">
   <button className="text-white group hover:text-[#FF41FF]
